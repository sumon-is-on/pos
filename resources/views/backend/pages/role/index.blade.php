...
<div class="flex justify-between items-center">
    <h1 class="text-4xl font-semibold" >Role List</h1>
    <div class="flex space-x-2 justify-end m-7 ">
        <a href="{{ route('admin.role.create') }}"><button type="button" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"> + Add User</button></a>
    </div>
</div>
<div class="m-3">
